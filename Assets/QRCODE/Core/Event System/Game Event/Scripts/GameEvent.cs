...
namespace QRCode.Events
{
    ...
    public static class GameEventInternal
    {
        ...
        public static void Init()
        {
            ...
            var a = typeof(GameEventAddressCore).GetCustomAttributes(true);
            var adressTest = typeof(AddressTest).GetCustomAttributes(true);
            ...
            foreach (var attribute in adressTest)
            {
                if (attribute is AddressAttribute address)
                {
                    Translator.Add(address.TypeReference, address.Pin);
